...
with st.expander("🚀 التشغيل السريع (Quick Start) - اضغط هنا"):
    ...
    2. **تفعيل الذكاء الاصطناعي  :** أدخل مفتاح OpenAI 
    الخاص بك في الشريط الجانبي (يسار الصفحة).
    و في حال لم تدخل المفتاح سيعمل المحاكي المنطقي بدل من الذكاء الاصطناعي
