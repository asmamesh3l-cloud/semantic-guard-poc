...
with st.expander("🚀 التشغيل السريع (Quick Start) - اضغط هنا"):
    ...
    <div class="quickstart-box">
        <ol>
            ...
            <li><b>تفعيل الذكاء الاصطناعي:</b> أدخل المفتاح الخاص بك في الشريط الجانبي (يسار الصفحة). وفي حال لم تدخل المفتاح سيعمل <b>المحاكي المنطقي</b> بدلاً من الذكاء الاصطناعي لضمان استمرار العرض.</li>
